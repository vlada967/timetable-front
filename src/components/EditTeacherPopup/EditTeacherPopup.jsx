...
function EditTeacherPopup({ isOpen, onClose, theTeacher, isChecked, availableSlots }) {
    ...
    function handleSubmit(e) {
        ...
        api.editTeacher(theTeacher.id, name, newSlots)
            .then(() => {
            })
            .catch((err) => {
                console.log(err);
    ...
    return (
        <PopupWithForm name='add-card' title='💖 Edit the teacher 💖' isOpen={isOpen} onClose={onClose} buttonText="Сохранить" onSubmit={handleSubmit}>
            <input
                value={name || ''}
